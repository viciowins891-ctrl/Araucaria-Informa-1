...
async function fixFoodTrucksV3() {
    console.log("🔧 Fixing Food Trucks News (V3 - Retry without mobile_image_url)...");
    ...
    else console.log("✅ Article updated successfully (V3 - without mobile_image_url)!");
}
