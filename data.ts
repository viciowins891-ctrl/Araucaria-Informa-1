...
export const newsArticles: NewsArticle[] = [
    ...
    },
    {
        ...
        content: `
        <p><strong>ARAUCÁRIA</strong> - A temporada 2026 começou oficialmente para o <strong>Araucária Esporte Clube</strong>. Em evento realizado nesta manhã no <strong>Estádio Municipal</strong>, a diretoria apresentou o elenco que disputará a Segunda Divisão do Campeonato Paranaense. Com o lema "Rumo à Elite", o Cacique investiu em reforços pontuais para o setor defensivo, mas manteve a espinha dorsal da equipe que quase subiu no ano passado.</p>
