...
export const newsArticles: NewsArticle[] = [
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/cinema_parque_interno.png" alt="Cinema lotado no Parque Cachoeira" class="w-full h-auto rounded-lg my-6 shadow-md" />

            <p>A iniciativa visa ocupar os espaços públicos com cultura e lazer seguro para as famílias araucarienses.</p>
        `,
        imageUrl: '/images/cinema_parque.jpg',
        category: 'Cultura',
