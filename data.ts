...
export const newsArticles: NewsArticle[] = [
    ...
    },
    {
        ...
        <h3>Futebol Raiz</h3>
        <p>"Isso aqui é a essência do futebol. Domingo de manhã, as famílias na beira do campo, o cheiro de churrasco e essa energia única", celebrou o presidente da Liga Desportiva. Com o resultado, o <strong>Grêmio</strong> assume a liderança isolada do <strong>Grupo B</strong> e já mira a classificação antecipada. A próxima rodada promete ainda mais emoção, com o esperado duelo entre <strong>Tropical</strong> e <strong>Juventus</strong>.</p>
        `,
