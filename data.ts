...
export const newsArticles: NewsArticle[] = [

    {
        ...
        content: `
        <p><strong>ARAUCÁRIA</strong> - O feriado de 11 de fevereiro, data que marca os <strong>136 anos de emancipação política de Araucária</strong>, foi celebrado em grande estilo pela população. O Parque Cachoeira, principal cartão-postal da cidade, ficou pequeno para as milhares de famílias que compareceram para prestigiar a festa, aproveitando o dia de sol e a vasta programação gratuita.</p>
    ...
    },
    {
        ...
        <p>A partida, disputada no <strong>campo do Costeira</strong>, foi um espetáculo à parte. A torcida compareceu em peso, com charangas, bandeiras e sinalizadores, transformando o alambrado em uma verdadeira arquibancada vibrante. Dentro de campo, o jogo foi lá e cá, com viradas no placar e muita disputa física, típica do futebol de várzea. O gol da vitória saiu aos 48 minutos do segundo tempo, em uma cobrança de falta magistral do meia Canhoto, que fez a festa da torcida gremista explodir.</p>
        <h3>Futebol Raiz</h3>
        <p>"Isso aqui é a essência do futebol. Domingo de manhã, as famílias na beira do campo, o cheiro de churrasco e essa energia única", celebrou o presidente da <strong>Liga Desportiva</strong>. Com o resultado, o <strong>Grêmio</strong> assume a liderança isolada do <strong>Grupo B</strong> e já mira a classificação antecipada. A próxima rodada promete ainda mais emoção, com o esperado duelo entre <strong>Tropical</strong> e <strong>Juventus</strong>.</p>
        `,
