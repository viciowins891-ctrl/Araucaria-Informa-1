        ...
        const fetchArticleAndRelated = async () => {
            ...
            try {
                ...
                if (currentArticle) {
                    ...
                    if (idNum === 108) secImg = '/images/cyclone_repair_internal.png'; // Ciclone (Interna) - Fix Duplicação
                    ...
                    if (idNum === 36) secImg = '/images/iptu_payment_guide_internal.jpg'; // IPTU (Interna)
                    if (idNum === 39) secImg = '/images/araucaria_volei_celebration_internal.jpg'; // Vôlei (Interna)
                    if (idNum === 40) secImg = '/images/healthy_cooking_course_internal.jpg'; // Culinária (Interna)
                    ...
                    if (idNum === 43) secImg = '/images/festa_junina_school_internal.jpg'; // Festa Junina (Interna)
