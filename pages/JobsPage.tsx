                        ...
                        {jobs.map((job) => (
                            <div key={job.id} className="bg-white dark:bg-surface-dark rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 dark:border-gray-700 p-6 flex flex-col h-full group relative overflow-hidden">
                                ...
                                <div className="flex gap-3">
                                    <a href={job.contactLink} target="_blank" rel="noopener noreferrer" className="flex-grow text-center bg-gray-50 hover:bg-primary hover:text-white text-gray-700 font-bold py-3 px-4 rounded-lg border border-gray-200 hover:border-primary transition-all duration-200 flex items-center justify-center gap-2">
                                        Candidatar-se
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                                    </a>
                                    <div className="flex-shrink-0">
                                        <ShareButton
                                            title={`Vaga: ${job.title} (${job.company})`}
                                            url="https://araucariainforma.com/vagas"
                                        />
                                    </div>
                                </div>
                            </div>
